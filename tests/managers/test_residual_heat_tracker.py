...
from custom_components.roommind_eklabs.managers.residual_heat_tracker import ResidualHeatTracker
...
@patch("custom_components.roommind_eklabs.managers.residual_heat_tracker.time")
