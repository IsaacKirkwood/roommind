/**
 * rme-settings-compressor – Compressor protection group management.
 */
...
import "../shared/rme-confirm-button";
import { inputStyles } from "../../styles/input-styles";

@customElement("rme-settings-compressor")
...
declare global {
  interface HTMLElementTagNameMap {
    "rme-settings-compressor": RsSettingsCompressor;
  }
}
