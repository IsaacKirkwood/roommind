/**
 * rme-settings-notifications – Feature-agnostic notification settings.
...
@customElement("rme-settings-notifications")
...
declare global {
  interface HTMLElementTagNameMap {
    "rme-settings-notifications": RsSettingsNotifications;
  }
}
