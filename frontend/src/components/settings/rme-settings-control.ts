/**
 * rme-settings-control – Control settings: mode, comfort weight, thresholds, prediction.
 */
...
@customElement("rme-settings-control")
...
declare global {
  interface HTMLElementTagNameMap {
    "rme-settings-control": RsSettingsControl;
  }
}
