/**
 * rme-settings-panel – Reusable accordion panel for settings sections.
 * Wraps ha-expansion-panel with icon, title, optional badge, and intro text.
 */
import { LitElement, html, css, nothing } from "lit";
import { customElement, property } from "lit/decorators.js";
import "../shared/rme-badge";

@customElement("rme-settings-panel")
    ...
    return html`
      <ha-expansion-panel outlined>
        <div slot="header" class="panel-header">
          ...
          ${
            this.badge
              ? html`<rme-badge .label=${this.badge} .hint=${this.badgeHint}></rme-badge>`
              : nothing
          }
        </div>
...
declare global {
  interface HTMLElementTagNameMap {
    "rme-settings-panel": RsSettingsPanel;
  }
}
