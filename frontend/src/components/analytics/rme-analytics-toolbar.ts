/**
 * rme-analytics-toolbar – Room selector, range buttons, export/diagnostics dropdowns.
 */
...
@customElement("rme-analytics-toolbar")
...
declare global {
  interface HTMLElementTagNameMap {
    "rme-analytics-toolbar": RsAnalyticsToolbar;
  }
}
