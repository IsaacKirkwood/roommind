                ...
                <div class="hero-temps">
                  ${e.current_temp===null?h`<span class="hero-current" style="opacity: 0.3">--</span>`:h`
                          <span class="hero-current"
                            >${O(e.current_temp,this.hass)}</span
                          >
...
`;v(),S(),M();var Ht=class extends _{constructor(...e){super(...e),this.masterWidth=`260px`,this.breakpoint=720}static{this.styles=l`
    ...
    .wrap {
      display: grid;
      grid-template-columns: var(--rme-master-width, 260px) minmax(0, 1fr);
      gap: 20px;
      align-items: start;
    }
  ...
  `}render(){return h`
      <div class="wrap" style="--rme-master-width: ${this.masterWidth};">
    ...
    `}_onSelectForEdit(e){this._selectedForEdit=e}_renderDeviceDetail(e){let t=this.devices.find(t=>t.entity_id===e);if(!t)return g;let n=t.type===`trv`,r=t.type===`ac`,i=this.hass.states[e],a=i?.attributes?.friendly_name||e,o=(i?.attributes?.hvac_modes??[]).includes(`fan_only`),s=this.valveProtectionExclude.has(e),c=this.hass.language;return h`
      ...
      ${r?h`
              ...
              ${(t.coil_dry??`inherit`)===`off`?g:h`
                      ...
                      <div class="detail-field with-info">
                        ...
                        ${t.coil_dry_mode===`dry`?h`<rme-info-icon
      ...
      ${n?h`
              <div class="detail-field with-info">
                ...
                ${t.idle_action===`low`?h`<rme-info-icon
      ...
      ${this.selectedTempSensor?h`
              <div class="detail-field with-info">
                ...
                <rme-info-icon
                  .text=${C(`devices.setpoint_mode_hint`,c)}
                ></rme-info-icon>
              </div>
            `:g}
    ...
    `]}render(){return this.editing?this._renderEditMode():this._renderViewMode()}_renderViewMode(){let e=!!this.temperatureSensor,t=!!this.humiditySensor,n=this.occupancySensors.size>0,r=this.windowSensors.size>0;if(!e&&!t&&!n&&!r)return g;let i=this.hass.language;return h`
      ...
      ${r?h`
              ...
              ${this.windowOpenDelay||this.windowCloseDelay?h`<div class="delay-view">
                      ${this.windowOpenDelay?h`${C(`devices.window_open_delay`,i)}:
                            ${this.windowOpenDelay}s`:g}
        ...
        >
          ...
          <div class="row-info">
            <div class="row-name-line">
              ...
              ${n?h`<span class="external-badge"
                      >${C(`devices.other_area`,a)}</span
                    >`:g}
            </div>
  ...
  `}render(){return h`
      <ha-card>
        <div class="section-header">
          ...
          ${this.badge?h`<rme-badge .label=${this.badge} .hint=${this.badgeHint}></rme-badge>`:g}
  ...
  `}get _allPersons(){let e=this.selectedPresencePersons.filter(e=>!this.presencePersons.includes(e));return[...this.presencePersons,...e]}_isMissing(e){return!this.hass.states[e]}render(){return!this.presenceEnabled||!this.editing&&this._allPersons.length===0?g:this.editing?h`
    ...
    `}_getBlockPosition(e){let t=this.hass?.states?.[e];if(!t||t.state!==`on`)return null;let n=t.attributes?.position;return n==null?null:Number(n)}_statusText(e,t){return C(e===`active`?`covers.schedule_state_active`:e===`unreachable`?`covers.schedule_state_unreachable`:`covers.schedule_state_inactive`,t)}_addSchedule(e){this._emitSchedules([...this.schedules,{entity_id:e,mode:`force`}])}_removeSchedule(e){this._emitSchedules(this.schedules.filter((t,n)=>n!==e))}_moveSchedule(e,t){let n=e+t;if(n<0||n>=this.schedules.length)return;let r=[...this.schedules];[r[e],r[n]]=[r[n],r[e]],this._emitSchedules(r)}_updateMode(e,t){let n=this.schedules.map((n,r)=>r===e?{...n,mode:t}:n);this._emitSchedules(n)}_emitSchedules(e){this.dispatchEvent(new CustomEvent(`cover-schedules-changed`,{detail:{value:e},bubbles:!0,composed:!0}))}_emitSelectorChanged(e){this.dispatchEvent(new CustomEvent(`cover-schedule-selector-changed`,{detail:{value:e},bubbles:!0,composed:!0}))}};j([b({attribute:!1})],Xt.prototype,`schedules`,void 0),Xt=j([y(`rme-cover-schedule`)],Xt),v(),S(),M();var Zt,W=class extends _{static{Zt=this}constructor(...e){super(...e),this.selectedCovers=new Set,this.editing=!1,this.autoEnabled=!1,this.deployThreshold=1.5,this.minPosition=0,this.overrideMinutes=60,this.autoPaused=!1,this.overrideUntil=null,this.coverSchedules=[],this.coverScheduleSelectorEntity=``,this.activeCoverScheduleIndex=-1,this.nightClose=!1,this.nightPosition=0,this.snapDeploy=!1,this.forcedReason=``,this.coverOrientations={},this.nightCloseElevation=0,this.nightCloseOffsetMinutes=0,this.outdoorMinTemp=10,this.coverMinPositions={},this._selectedForEdit=``,this._scheduleCollapsed=!0,this._solarCollapsed=!0,this._entityFilter=e=>{let t=e.entity_id;return!t.startsWith(`cover.roommind_`)&&t.startsWith(`cover.`)&&!this.selectedCovers.has(t)}}willUpdate(e){e.has(`selectedCovers`)&&(this._selectedForEdit&&!this.selectedCovers.has(this._selectedForEdit)&&(this._selectedForEdit=``),!this._selectedForEdit&&this.selectedCovers.size>0&&(this._selectedForEdit=[...this.selectedCovers][0]))}static{this.styles=[Vt,P,l`
      ...
      /* Tile view rows (match rme-sensor-section visual rhythm) */
      .view-row {
        display: flex;
        align-items: center;
        gap: 10px;
      ...
      /* Device-row style (matches rme-device-section) */
      .device-list-scroll {
        max-height: 210px;
        overflow-y: auto;
      }
      ...
      ${i?h`
              ...
              ${this.autoEnabled?h`
                      <div class="group-card ${this._scheduleCollapsed?`collapsed`:``}">
                        ...
                        ${this._scheduleCollapsed?g:h`<rme-cover-schedule
                                  .hass=${this.hass}
    ...
    `:this.enabled?h`<div class="summary">
      ...
      <div class="threshold-cell">
        <div class="threshold-label">
          <span>${e.label}</span>
          <rme-info-icon .text=${e.hint}></rme-info-icon>
        </div>
        <ha-textfield
  ...
  `}render(){return this.open?h`
    ...
    /* Section cards handled by rme-section-card */
  ...
  `}connectedCallback(){super.connectedCallback(),this._initFromConfig()}disconnectedCallback(){super.disconnectedCallback(),this._saveDebounce&&clearTimeout(this._saveDebounce)}updated(e){let t=this.config?.area_id??this.area?.area_id??null;t===this._prevAreaId?e.has(`config`)&&!this._dirty&&(e.get(`config`)??this._initFromConfig()):(this._initFromConfig(),this._prevAreaId=t),e.has(`config`)&&this._optimisticCoverResume&&!this.config?.live?.cover_auto_paused&&(this._optimisticCoverResume=!1)}_initFromConfig(){this.config?(this._devices=this.config.devices?.length?[...this.config.devices]:[...(this.config.thermostats??[]).map(e=>({entity_id:e,type:`trv`,role:`auto`,heating_system_type:this.config.heating_system_type??``})),...(this.config.acs??[]).map(e=>({entity_id:e,type:`ac`,role:`auto`}))],this._selectedTempSensor=this.config.temperature_sensor,this._selectedHumiditySensor=this.config.humidity_sensor??``,this._selectedOccupancySensors=new Set(this.config.occupancy_sensors??[]),this._selectedWindowSensors=new Set(this.config.window_sensors??[]),this._windowOpenDelay=this.config.window_open_delay??0,this._windowCloseDelay=this.config.window_close_delay??0,this._climateMode=this.config.climate_mode,this._schedules=this.config.schedules??[],this._scheduleSelectorEntity=this.config.schedule_selector_entity??``,this._comfortHeat=this.config.comfort_heat??this.config.comfort_temp??21,this._comfortCool=this.config.comfort_cool??24,this._ecoHeat=this.config.eco_heat??this.config.eco_temp??17,this._ecoCool=this.config.eco_cool??27,this._selectedPresencePersons=this.config.presence_persons??[],this._displayName=this.config.display_name??``,this._selectedCovers=new Set(this.config.covers??[]),this._coversAutoEnabled=this.config.covers_auto_enabled??!1,this._coversDeployThreshold=this.config.covers_deploy_threshold??1.5,this._coversMinPosition=this.config.covers_min_position??0,this._coversOverrideMinutes=this.config.covers_override_minutes??60,this._coverSchedules=this.config.cover_schedules??[],this._coverScheduleSelectorEntity=this.config.cover_schedule_selector_entity??``,this._coversNightClose=this.config.covers_night_close??!1,this._coversNightPosition=this.config.covers_night_position??0,this._coversSnapDeploy=this.config.covers_snap_deploy??!1,this._coverOrientations=this.config.cover_orientations??{},this._coversNightCloseElevation=this.config.covers_night_close_elevation??0,this._coversNightCloseOffsetMinutes=this.config.covers_night_close_offset_minutes??0,this._coversOutdoorMinTemp=this.config.covers_outdoor_min_temp??10,this._coverMinPositions=this.config.cover_min_positions??{},this._ignorePresence=this.config.ignore_presence??!1,this._isOutdoor=this.config.is_outdoor??!1,this._valveProtectionExclude=new Set(this.config.valve_protection_exclude??[]),this._climateControlEnabled=this.config.climate_control_enabled??!0,this._heatSourceOrchestration=this.config.heat_source_orchestration??!1,this._heatSourcePrimaryDelta=this.config.heat_source_primary_delta??1.5,this._heatSourceOutdoorThreshold=this.config.heat_source_outdoor_threshold??5,this._heatSourceAcMinOutdoor=this.config.heat_source_ac_min_outdoor??-15):(this._devices=[],this._selectedTempSensor=``,this._selectedHumiditySensor=``,this._selectedOccupancySensors=new Set,this._selectedWindowSensors=new Set,this._windowOpenDelay=0,this._windowCloseDelay=0,this._climateMode=`auto`,this._schedules=[],this._scheduleSelectorEntity=``,this._comfortHeat=21,this._comfortCool=24,this._ecoHeat=17,this._ecoCool=27,this._selectedPresencePersons=[],this._displayName=``,this._selectedCovers=new Set,this._coversAutoEnabled=!1,this._coversDeployThreshold=1.5,this._coversMinPosition=0,this._coversOverrideMinutes=60,this._coverSchedules=[],this._coverScheduleSelectorEntity=``,this._coversNightClose=!1,this._coversNightPosition=0,this._coversSnapDeploy=!1,this._coverOrientations={},this._coversNightCloseElevation=0,this._coversNightCloseOffsetMinutes=0,this._coversOutdoorMinTemp=10,this._coverMinPositions={},this._ignorePresence=!1,this._isOutdoor=!1,this._valveProtectionExclude=new Set,this._climateControlEnabled=!0,this._heatSourceOrchestration=!1,this._heatSourcePrimaryDelta=1.5,this._heatSourceOutdoorThreshold=5,this._heatSourceAcMinOutdoor=-15),this._dirty=!1,this._devices.length===0&&this._editing===null&&(this._editing=`devices`)}_getEffectiveOverride(){let e=this.shadowRoot?.querySelector(`rme-override-section`);if(e)return e.getEffectiveOverride();let t=this.config?.live;return t?.override_active&&t.override_type?{active:!0,type:t.override_type,heat:t.override_heat,cool:t.override_cool,until:t.override_until}:{active:!1,type:null,heat:null,cool:null,until:null}}render(){return this.area?h`
      <div class="detail-layout">
        ...
        <div class="detail-grid">
          ${this._isOutdoor?g:h`
                  ...
                  >
                    <rme-info-icon slot="header-extras">
          ...
          ${this._isOutdoor?g:h`
                  ...
                  ${this.presenceEnabled&&(this.presencePersons.length>0||this._selectedPresencePersons.length>0)?h`<rme-section-card
                ...
                `}
          ${this._isOutdoor?g:h`<rme-section-card
          ...
          ${!this._isOutdoor&&this._selectedTempSensor&&this._devices.some(e=>e.type===`trv`)&&this._devices.some(e=>e.type===`ac`)?h`<rme-section-card
    ...
    `:g}_renderEditDialog(){if(this._editing===null)return g;let e=this.hass.language;switch(this._editing){case`schedule`:return h`<rme-edit-dialog
          open
          icon="mdi:calendar"
          .heading=${C(`room.section.schedule`,e)}
          hasInfo
          @rme-dialog-closed=${this._closeEdit}
        >
          <div slot="info">
  ...
  <span class="yaml-key">data</span>:
    ...
    <span class="yaml-key">cool_temperature</span>: <span class="yaml-value">24</span>`)}
          ...
          <rme-schedule-settings
            ...
            @eco-cool-changed=${this._onEcoCoolChanged}
          ></rme-schedule-settings>
        </rme-edit-dialog>`;case`devices`:return h`<rme-edit-dialog
          open
          icon="mdi:power-plug"
        ...
        >
          ...
          <rme-device-section
            ...
            @valve-protection-exclude-toggle=${this._onValveProtectionExcludeToggle}
          ></rme-device-section>
        </rme-edit-dialog>`;case`sensors`:return h`<rme-edit-dialog
          open
          icon="mdi:thermometer"
        ...
        >
          <rme-sensor-section
            ...
            @sensor-changed=${this._onSensorChanged}
          ></rme-sensor-section>
        </rme-edit-dialog>`;case`presence`:return h`<rme-edit-dialog
          open
          icon="mdi:home-account"
        ...
        >
          ...
          <rme-presence-section
            ...
            @ignore-presence-changed=${this._onIgnorePresenceChanged}
          ></rme-presence-section>
        </rme-edit-dialog>`;case`covers`:return h`<rme-edit-dialog
          open
          icon="mdi:blinds-horizontal"
      ...
      - <span class="yaml-key">from</span>: <span class="yaml-value">"20:00:00"</span>
        ...
        <span class="yaml-key">data</span>:
          ...
          <rme-covers-section
            ...
            @cover-resume-auto=${this._onCoverResumeAuto}
          ></rme-covers-section>
        </rme-edit-dialog>`;case`heatSource`:return h`<rme-edit-dialog
          open
          icon="mdi:swap-horizontal"
    ...
    `]}};j([b({attribute:!1})],gn.prototype,`hass`,void 0),j([b({type:String})],gn.prototype,`controlMode`,void 0),j([b({type:Number})],gn.prototype,`comfortWeight`,void 0),j([b({type:Number})],gn.prototype,`outdoorCoolingMin`,void 0),j([b({type:Number})],gn.prototype,`outdoorHeatingMax`,void 0),j([b({type:Boolean})],gn.prototype,`predictionEnabled`,void 0),j([b({type:String})],gn.prototype,`scheduleOffAction`,void 0),gn=j([y(`rme-settings-control`)],gn),v(),S(),M();var _n=class extends q{constructor(...e){super(...e),this.presenceEnabled=!1,this.presencePersons=[],this.presenceAwayAction=`eco`,this.presenceClearsOverride=!1}render(){let e=this.hass.language;return h`
      ...
      ${this.presenceEnabled?h`
              <div class="detail-section">
                ...
                >
                  <ha-list-item value="eco"
                    >${C(`presence.away_action_eco`,e)}</ha-list-item
                  >
                  <ha-list-item value="off"
                    >${C(`presence.away_action_off`,e)}</ha-list-item
                  >
                </ha-select>
                <div class="toggle-row">
                  <div class="toggle-text">
                    <span class="toggle-label"
                      >${C(`presence.clears_override_label`,e)}</span
                    >
  ...
  `}render(){return h`
        ...
        ${e.master_entity||e.enforce_uniform_mode?h`
                <div class="field-row">
                  ...
                  <div class="field-hint">
                    ${C(`compressor.conflict_resolution_hint`,n)}
                  </div>
                </div>
              `:g}
    ...
    `]}render(){return h`
      ${this.sharedHeatSources.map((e,t)=>this._renderSource(e,t))}
      <ha-button @click=${this._add}
        ><ha-icon icon="mdi:plus" slot="icon"></ha-icon>Add whole-house heater</ha-button
      >
    `}_renderSource(e,t){return h`<div class="source">
      <ha-textfield
        label="Name"
        .value=${e.name}
        @change=${e=>this._set(t,`name`,e.target.value)}
      ></ha-textfield>
      <div class="grid">
        <div>
          <ha-entity-picker
            ...
            @value-changed=${e=>this._set(t,`entity_id`,e.detail?.value??``)}
          ></ha-entity-picker>
        ...
        <ha-textfield
          ...
          suffix="min"
          .value=${String(e.local_grace_minutes)}
          @change=${e=>this._number(t,`local_grace_minutes`,e)}
        ></ha-textfield>
        <ha-textfield
          type="number"
          min="0"
          ...
          suffix="°C"
          .value=${String(e.local_trim_delta)}
          @change=${e=>this._number(t,`local_trim_delta`,e)}
        ></ha-textfield>
        <ha-textfield
          type="number"
          min="0"
    ...
    `]}render(){let e=this.plant;return h`<div class="grid">
      ...
      ${this._number(`Cooling target`,`cooling_target`,`°C`,16,35,.5)}
      ${this._number(`Start above target`,`cooling_start_delta`,`°C`,.1,5,.1)}
      ${this._number(`Stop above target`,`cooling_stop_delta`,`°C`,0,5,.1)}
      ${this._number(`Minimum outdoor temperature`,`minimum_outdoor_cooling_temp`,`°C`,0,40,.5)}
      ${this._number(`Maximum outdoor humidity`,`evaporative_max_outdoor_humidity`,`%`,10,100,1)}
      ${this._number(`Minimum indoor/outdoor advantage`,`evaporative_min_indoor_outdoor_delta`,`°C`,0,15,.5)}
      ${this._number(`Maximum continuous run`,`max_continuous_runtime_minutes`,`min`,15,720,15)}
      <ha-formfield label="Require someone home"
        ><ha-checkbox
          .checked=${e.require_home_presence}
          @change=${e=>this._set(`require_home_presence`,e.target.checked)}
        ></ha-checkbox
      ></ha-formfield>
      <ha-formfield label="Require downstairs occupancy"
        ><ha-checkbox
          .checked=${e.require_occupancy}
          @change=${e=>this._set(`require_occupancy`,e.target.checked)}
        ></ha-checkbox
      ></ha-formfield>
      <div>
        <ha-entity-picker
          .hass=${this.hass}
          .value=${e.indoor_humidity_sensor}
          .includeDomains=${[`sensor`]}
          label="Indoor humidity sensor"
          @value-changed=${e=>this._set(`indoor_humidity_sensor`,e.detail?.value??``)}
        ></ha-entity-picker>
      </div>
      ${this._picker(`Add temperature sensor`,`temperature_sensors`,[`sensor`])}
      <div class="wide">${e.temperature_sensors.map(e=>this._temperatureRow(e))}</div>
    ...
    </div>`}_number(e,t,n,r,i,a){return h`<ha-textfield
      type="number"
      label=${e}
      suffix=${n}
      min=${String(r)}
      max=${String(i)}
      step=${String(a)}
      .value=${String(this.plant[t])}
      @change=${e=>this._set(t,Number(e.target.value))}
    ></ha-textfield>`}_picker(e,t,n){let r=this.plant[t]??[];return h`<div>
      <ha-entity-picker
        .hass=${this.hass}
        .value=${``}
        .includeDomains=${n}
        label=${e}
        @value-changed=${e=>{let n=e.detail?.value;n&&this._set(t,[...new Set([...r,n])])}}
      ></ha-entity-picker>
      ${r.map(e=>h`<div class="row">
            <span>${this.hass.states[e]?.attributes?.friendly_name??e}</span><span></span>
            <ha-icon-button
              label="Remove"
              .path=${`M19,13H5V11H19V13Z`}
              @click=${()=>this._set(t,r.filter(t=>t!==e))}
            ></ha-icon-button>
          </div>`)}
    </div>`}_temperatureRow(e){let t=this.plant.temperature_offsets[e]??0;return h`<div class="row">
      <span>${this.hass.states[e]?.attributes?.friendly_name??e}</span>
      <ha-textfield
        type="number"
        label="Correction"
        suffix="°C"
        ...
        step="0.1"
        .value=${String(t)}
        @change=${t=>this._set(`temperature_offsets`,{...this.plant.temperature_offsets,[e]:Number(t.target.value)})}
      ></ha-textfield>
      <ha-icon-button
        label="Remove"
        .path=${`M19,13H5V11H19V13Z`}
        @click=${()=>{let t={...this.plant.temperature_offsets};delete t[e],this._fire({...this.plant,temperature_sensors:this.plant.temperature_sensors.filter(t=>t!==e),temperature_offsets:t})}}
      ></ha-icon-button>
    </div>`}_set(e,t){this._fire({...this.plant,[e]:t})}_fire(e){this.dispatchEvent(new CustomEvent(`setting-changed`,{detail:{key:`wholeHousePlant`,value:e},bubbles:!0,composed:!0}))}};j([b({attribute:!1})],Cn.prototype,`hass`,void 0),j([b({attribute:!1})],Cn.prototype,`plant`,void 0),Cn=j([y(`rme-settings-whole-house-plant`)],Cn),v(),S(),M();var wn=`__keep__`,J=class extends q{constructor(...e){super(...e),this.coilDryEnabled=!1,this.coilDryMinutes=20,this.coilDryMode=`fan_only`,this.coilDryFanMode=`low`,this.coilDryMinCoolingMinutes=10,this.coilDryDrainMinutes=0,this.availableFanModes=[]}_numberField(e,t,n,r,i,a,o){let s=this.hass.language;return h`
      <div class="threshold-field">
        <ha-textfield
          .value=${String(t)}
          .label=${C(n,s)}
              ...
              <div class="threshold-grid" style="margin-top: 12px">
                <div class="threshold-field">
                  <ha-select
                    ...
                    .value=${this.coilDryFanMode===``?wn:this.coilDryFanMode}
                    .options=${[{value:wn,label:C(`coil_dry.fan_mode_keep`,e)},...t.map(e=>({value:e,label:e}))]}
                    @selected=${e=>{let t=L(e),n=this.coilDryFanMode===``?wn:this.coilDryFanMode;t&&t!==n&&this._fire(`coilDryFanMode`,t===wn?``:t)}}
                    @closed=${e=>e.stopPropagation()}
                    fixedMenuPosition
                  >
                    <ha-list-item value="${wn}"
    ...
    `}static{this.styles=[q.settingsBaseStyles]}};j([b({attribute:!1})],Tn.prototype,`hass`,void 0),j([b({type:Boolean})],Tn.prototype,`moldDetectionEnabled`,void 0),j([b({type:Number})],Tn.prototype,`moldHumidityThreshold`,void 0),j([b({type:Number})],Tn.prototype,`moldSustainedMinutes`,void 0),j([b({type:Boolean})],Tn.prototype,`moldPreventionEnabled`,void 0),j([b({type:String})],Tn.prototype,`moldPreventionIntensity`,void 0),Tn=j([y(`rme-settings-mold`)],Tn),v(),S(),M();var En=class extends q{constructor(...e){super(...e),this.notificationsEnabled=!0,this.notificationTargets=[],this.notificationCooldown=60,this.moldPreventionEnabled=!1,this.moldPreventionNotify=!1}render(){let e=this.hass.language;return h`
      <div class="toggle-row">
        <div class="toggle-text">
    ...
    `]}};j([b({attribute:!1})],En.prototype,`hass`,void 0),j([b({type:Boolean})],En.prototype,`notificationsEnabled`,void 0),j([b({type:Array})],En.prototype,`notificationTargets`,void 0),j([b({type:Number})],En.prototype,`notificationCooldown`,void 0),j([b({type:Boolean})],En.prototype,`moldPreventionEnabled`,void 0),j([b({type:Boolean})],En.prototype,`moldPreventionNotify`,void 0),En=j([y(`rme-settings-notifications`)],En),v(),S(),M();var Dn=250,On=class extends q{constructor(...e){super(...e),this.rooms={},this.learningDisabledRooms=[],this.boostAppliedAt={},this.roomsLive={},this._showLearningExceptions=!1,this._boostSelectedRoom=``}render(){let e=this.hass.language,t=Object.entries(this.rooms).map(([e])=>({areaId:e,name:this.hass.areas?.[e]?.name??e})).sort((e,t)=>e.name.localeCompare(t.name)),n=Object.keys(this.rooms),r=n.length===0||this.learningDisabledRooms.length<n.length,i=this.learningDisabledRooms.filter(e=>n.includes(e)).length;return h`
      <!-- Learning toggle -->
      <div class="settings-section first">
        <div class="toggle-row">
          <div class="toggle-text">
    ...
    `}_isCooldown(e){let t=this.roomsLive?.[e]?.n_observations??0,n=this.boostAppliedAt[e];return n!==void 0&&t-n<Dn}async _boostLearning(e){try{R(this,`saving`);let t=await this.hass.callWS({type:`roommind_eklabs/model/boost_learning`,area_id:e});R(this,`saved`),this.dispatchEvent(new CustomEvent(`boost-applied`,{detail:{area_id:e,n_observations:t.n_observations},bubbles:!0,composed:!0}))}catch{R(this,`error`)}}static{this.styles=[q.settingsBaseStyles,l`
      .hint {
        color: var(--secondary-text-color);
        font-size: 13px;
        margin: 4px 0 12px;
    ...
    `]}};j([b({attribute:!1})],On.prototype,`hass`,void 0),j([b({attribute:!1})],On.prototype,`rooms`,void 0),j([b({type:Array})],On.prototype,`learningDisabledRooms`,void 0),j([b({attribute:!1})],On.prototype,`boostAppliedAt`,void 0),j([b({attribute:!1})],On.prototype,`roomsLive`,void 0),j([x()],On.prototype,`_showLearningExceptions`,void 0),j([x()],On.prototype,`_boostSelectedRoom`,void 0),On=j([y(`rme-settings-learning`)],On),v(),S(),M();var kn=class extends q{constructor(...e){super(...e),this.rooms={},this._resetSelectedRoom=``}render(){let e=this.hass.language,t=Object.entries(this.rooms).map(([e])=>({areaId:e,name:this.hass.areas?.[e]?.name??e})).sort((e,t)=>e.name.localeCompare(t.name));return h`
      <div class="settings-section first">
        <div class="reset-row">
    ...
    `]}};j([b({attribute:!1})],kn.prototype,`hass`,void 0),j([b({attribute:!1})],kn.prototype,`rooms`,void 0),j([x()],kn.prototype,`_resetSelectedRoom`,void 0),kn=j([y(`rme-settings-reset`)],kn),v(),S(),M();var Y=class extends _{constructor(...e){super(...e),this.rooms={},this._groupByFloor=!1,this._climateControlActive=!0,this._learningDisabledRooms=[],this._outdoorTempSensor=``,this._outdoorHumiditySensor=``,this._outdoorCoolingMin=16,this._outdoorHeatingMax=22,this._controlMode=`mpc`,this._comfortWeight=70,this._weatherEntity=``,this._outdoorUnavailableNotify=!0,this._predictionEnabled=!0,this._vacationActive=!1,this._vacationTemp=15,this._vacationUntil=``,this._presenceEnabled=!1,this._presencePersons=[],this._presenceAwayAction=`eco`,this._presenceClearsOverride=!1,this._scheduleOffAction=`eco`,this._valveProtectionEnabled=!1,this._valveProtectionInterval=7,this._moldDetectionEnabled=!1,this._moldHumidityThreshold=70,this._moldSustainedMinutes=30,this._moldNotificationCooldown=60,this._moldNotificationsEnabled=!0,this._moldNotificationTargets=[],this._moldPreventionEnabled=!1,this._moldPreventionIntensity=`medium`,this._moldPreventionNotify=!1,this._compressorGroups=[],this._sharedHeatSources=[],this._wholeHousePlant={enabled:!1,entity_id:``,cooling_target:24,cooling_start_delta:.5,cooling_stop_delta:.2,minimum_outdoor_cooling_temp:18,evaporative_max_outdoor_humidity:80,evaporative_min_indoor_outdoor_delta:1,max_continuous_runtime_minutes:240,feedback_timeout_seconds:120,stale_after_seconds:180,require_home_presence:!0,require_occupancy:!0,temperature_sensors:[],temperature_offsets:{},indoor_humidity_sensor:``,home_presence_entities:[],occupancy_entities:[],media_player_entities:[],ventilation_request_entities:[]},this._coilDryEnabled=!1,this._coilDryMinutes=20,this._coilDryMode=`fan_only`,this._coilDryFanMode=`low`,this._coilDryMinCoolingMinutes=10,this._coilDryDrainMinutes=0,this._boostAppliedAt={},this._loaded=!1}connectedCallback(){super.connectedCallback(),this._loadSettings()}disconnectedCallback(){super.disconnectedCallback(),this._saveDebounce&&clearTimeout(this._saveDebounce)}async _loadSettings(){try{let e=(await this.hass.callWS({type:`roommind_eklabs/settings/get`})).settings;this._groupByFloor=e.group_by_floor??!1,this._climateControlActive=e.climate_control_active??!0,this._learningDisabledRooms=e.learning_disabled_rooms??[],this._outdoorTempSensor=e.outdoor_temp_sensor??``,this._outdoorHumiditySensor=e.outdoor_humidity_sensor??``,this._outdoorCoolingMin=e.outdoor_cooling_min??16,this._outdoorHeatingMax=e.outdoor_heating_max??22,this._controlMode=e.control_mode??`mpc`,this._comfortWeight=e.comfort_weight??70,this._weatherEntity=e.weather_entity??``,this._outdoorUnavailableNotify=e.outdoor_unavailable_notify??!0,this._predictionEnabled=e.prediction_enabled??!0;let t=e.vacation_until;this._vacationActive=!!(t&&t>Date.now()/1e3),this._vacationTemp=e.vacation_temp??15,this._vacationUntil=t&&t>Date.now()/1e3&&t<3250368e4?this._tsToDatetimeLocal(t):``,this._presenceEnabled=e.presence_enabled??!1,this._presencePersons=e.presence_persons??[],this._presenceAwayAction=e.presence_away_action??`eco`,this._presenceClearsOverride=e.presence_clears_override??!1,this._scheduleOffAction=e.schedule_off_action??`eco`,this._valveProtectionEnabled=e.valve_protection_enabled??!1,this._valveProtectionInterval=e.valve_protection_interval_days??7,this._moldDetectionEnabled=e.mold_detection_enabled??!1,this._moldHumidityThreshold=e.mold_humidity_threshold??70,this._moldSustainedMinutes=e.mold_sustained_minutes??30,this._moldNotificationCooldown=e.mold_notification_cooldown??60,this._moldNotificationsEnabled=e.mold_notifications_enabled??!0,this._moldNotificationTargets=e.mold_notification_targets??[],this._moldPreventionEnabled=e.mold_prevention_enabled??!1,this._moldPreventionIntensity=e.mold_prevention_intensity??`medium`,this._moldPreventionNotify=e.mold_prevention_notify_enabled??!1,this._compressorGroups=e.compressor_groups??[],this._sharedHeatSources=e.shared_heat_sources??[],this._wholeHousePlant={...this._wholeHousePlant,...e.whole_house_plant??{}},this._coilDryEnabled=e.coil_dry_enabled??!1,this._coilDryMinutes=e.coil_dry_minutes??20,this._coilDryMode=e.coil_dry_mode??`fan_only`,this._coilDryFanMode=e.coil_dry_fan_mode??`low`,this._coilDryMinCoolingMinutes=e.coil_dry_min_cooling_minutes??10,this._coilDryDrainMinutes=e.coil_dry_drain_minutes??0,this._boostAppliedAt=e.boost_applied_at??{}}catch(e){console.debug(`[RoomMind] loadSettings:`,e)}finally{this._loaded=!0}}render(){if(!this._loaded)return h`<div class="loading">${C(`panel.loading`,this.hass.language)}</div>`;let e=this.hass.language;return h`
      ...
      <rme-settings-panel .heading=${C(`coil_dry.title`,e)} icon="mdi:air-filter">
...
`)}function jn(e,t,n){let r=new Blob([e],{type:`${n};charset=utf-8`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=t,a.click(),URL.revokeObjectURL(i)}function Mn(e,t,n,r,i,a,o){let s=e?.areas?.[n],c=(t[n]?.display_name||s?.name||n).replace(/\s+/g,`_`).toLowerCase();return a?`roommind_${a}_${c}.${o}`:`roommind_${c}_${new Date(r).toISOString().slice(0,10)}_${new Date(i).toISOString().slice(0,10)}.${o}`}function Nn(e){return navigator.clipboard?.writeText?(navigator.clipboard.writeText(e).catch(()=>{Pn(e)}),!0):Pn(e)}function Pn(e){let t=document.createElement(`textarea`);t.value=e,t.style.position=`fixed`,t.style.opacity=`0`,document.body.appendChild(t),t.select();let n=!1;try{n=document.execCommand(`copy`)}catch(e){console.debug(`[RoomMind] clipboard fallback:`,e)}return document.body.removeChild(t),n}v(),S(),M();var X=class extends _{constructor(...e){super(...e),this.rooms={},this.selectedRoom=``,this.rangeStart=0,this.rangeEnd=0,this.activeQuick=`24h`,this.data=null,this.language=`en`,this._openDropdown=null,this._diagLoading=!1,this._boundCloseDropdowns=this._closeDropdowns.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener(`click`,this._boundCloseDropdowns)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`click`,this._boundCloseDropdowns)}updated(e){(e.has(`rooms`)||e.has(`selectedRoom`))&&this.selectedRoom&&this.updateComplete.then(()=>{let e=this.renderRoot?.querySelector(`ha-select`);e&&e.value!==this.selectedRoom&&(e.value=this.selectedRoom)})}render(){let e=this.language,t=this._getConfiguredRooms();return h`
    ...
    `}_onRoomSelected(e){let t=L(e);t&&t!==this.selectedRoom&&this.dispatchEvent(new CustomEvent(`room-selected`,{detail:{areaId:t},bubbles:!0,composed:!0}))}_onQuickRange(e,t){let n=new Date,r=new Date(n);r.setDate(r.getDate()-(t-1)),r.setHours(0,0,0,0),this.dispatchEvent(new CustomEvent(`range-changed`,{detail:{activeQuick:e,rangeStart:r.getTime(),rangeEnd:n.getTime(),chartAnchor:n.getTime()},bubbles:!0,composed:!0}))}_onDateRangeChanged(e){let{startDate:t,endDate:n}=e.detail.value;!t||!n||this.dispatchEvent(new CustomEvent(`range-changed`,{detail:{activeQuick:null,rangeStart:t.getTime(),rangeEnd:n.getTime(),chartAnchor:n.getTime()},bubbles:!0,composed:!0}))}_exportCsv(){if(!this.data)return;let e=An(this.data);e&&(jn(e,Mn(this.hass,this.rooms,this.selectedRoom,this.rangeStart,this.rangeEnd,``,`csv`),`text/csv`),this._openDropdown=null)}async _exportDiagnostics(){if(!this._diagLoading){this._diagLoading=!0,this._openDropdown=null;try{let e=await this.hass.callWS({type:`roommind_eklabs/diagnostics/get`});jn(JSON.stringify(e,null,2),`roommind_diagnostics.json`,`application/json`)}catch(e){console.warn(`[RoomMind] diagnostics export failed:`,e)}finally{this._diagLoading=!1}}}_copyCsvToClipboard(){if(!this.data)return;let e=An(this.data);e&&(Nn(e),this._openDropdown=null)}async _copyDiagnosticsToClipboard(){if(!this._diagLoading){this._diagLoading=!0,this._openDropdown=null;try{let e=await this.hass.callWS({type:`roommind_eklabs/diagnostics/get`});Nn(JSON.stringify(e,null,2))}catch(e){console.warn(`[RoomMind] diagnostics clipboard failed:`,e)}finally{this._diagLoading=!1}}}_toggleDropdown(e){this._openDropdown=this._openDropdown===e?null:e}_closeDropdowns(){this._openDropdown&&=null}static{this.styles=[P,l`
      :host {
        display: block;
      }
    ...
    `]}};j([b({attribute:!1})],X.prototype,`hass`,void 0),j([b({attribute:!1})],X.prototype,`rooms`,void 0),j([b({type:String})],X.prototype,`selectedRoom`,void 0),j([b({type:Number})],X.prototype,`rangeStart`,void 0),j([b({type:Number})],X.prototype,`rangeEnd`,void 0),j([b({type:String})],X.prototype,`activeQuick`,void 0),j([b({attribute:!1})],X.prototype,`data`,void 0),j([b({type:String})],X.prototype,`language`,void 0),j([x()],X.prototype,`_openDropdown`,void 0),j([x()],X.prototype,`_diagLoading`,void 0),X=j([y(`rme-analytics-toolbar`)],X),v();var Fn=l`
  .info-icon {
    --mdc-icon-size: 16px;
    color: var(--secondary-text-color);
    opacity: 0.3;
...
`,In=108e5;function Ln(e,t){let{hass:n,language:r,chartAnchor:i,forecast:a,isOutdoor:o}=t,s=e=>T(e,n),c=[],l=[],u=[],d=[],ee=[];for(let t of e){let e=t.ts*1e3;t.room_temp!==null&&c.push([e,s(t.room_temp)]),!o&&t.target_temp!==null&&l.push([e,s(t.target_temp)]),!o&&t.predicted_temp!==null&&u.push([e,s(t.predicted_temp)]),t.outdoor_temp!==null&&d.push([e,s(t.outdoor_temp)]),!o&&t.device_setpoint!=null&&ee.push([e,s(t.device_setpoint)])}for(let e of a??[]){let t=e.ts*1e3;!o&&e.target_temp!==null&&l.push([t,s(e.target_temp)]),!o&&e.predicted_temp!==null&&u.push([t,s(e.predicted_temp)])}let f=[{id:`room_temp`,type:`line`,name:C(`analytics.temperature`,r),color:`rgb(255, 152, 0)`,data:c,showSymbol:!1,smooth:!0,lineStyle:{width:2},yAxisIndex:0}];o||f.push({id:`target_temp`,type:`line`,name:C(`analytics.target`,r),color:`rgb(76, 175, 80)`,data:l,showSymbol:!1,smooth:!1,lineStyle:{width:2,type:`dashed`},yAxisIndex:0}),u.length>0&&f.push({id:`predicted_temp`,type:`line`,name:C(`analytics.prediction`,r),color:`rgb(33, 150, 243)`,data:u,showSymbol:!1,smooth:!0,lineStyle:{width:2,type:`dotted`},yAxisIndex:0}),ee.length>0&&f.push({id:`device_target`,type:`line`,name:`TRV / AC`,color:`rgb(156, 39, 176)`,data:ee,showSymbol:!1,smooth:!1,step:`end`,lineStyle:{width:1,type:`dashed`},yAxisIndex:0}),d.length>0&&f.push({id:`outdoor_temp`,type:`line`,name:C(`analytics.outdoor`,r),color:`rgb(158, 158, 158)`,data:d,showSymbol:!1,smooth:!0,lineStyle:{width:1},yAxisIndex:0});let te=[],ne=[],re=[],ie=!1,ae=!1,oe=!1;for(let t of e){let e=t.ts*1e3;t.mode===`heating`?(te.push([e,999]),ie=!0):te.push([e,null]),t.mode===`cooling`?(ne.push([e,999]),ae=!0):ne.push([e,null]),t.window_open?(re.push([e,999]),oe=!0):re.push([e,null])}return ie&&f.push({id:`heating_events`,type:`line`,name:C(`analytics.heating_period`,r),color:`rgb(244, 67, 54)`,data:te,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:`rgba(244, 67, 54, 0.08)`,origin:`start`},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),ae&&f.push({id:`cooling_events`,type:`line`,name:C(`analytics.cooling_period`,r),color:`rgb(63, 81, 181)`,data:ne,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:`rgba(63, 81, 181, 0.08)`,origin:`start`},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),oe&&f.push({id:`window_events`,type:`line`,name:C(`analytics.window_open_period`,r),color:`rgb(0, 150, 136)`,data:re,showSymbol:!1,lineStyle:{width:0},areaStyle:{color:`rgba(0, 150, 136, 0.1)`,origin:`start`},tooltip:{show:!1},yAxisIndex:0,z:-1,connectNulls:!1}),f.push({id:`now_marker`,type:`line`,name:``,color:`rgba(255,255,255,0.3)`,data:[[i,-999],[i,999]],showSymbol:!1,lineStyle:{width:1,type:`dashed`},yAxisIndex:0,tooltip:{show:!1},z:-2}),f}function Rn(e,t,n){let{hass:r,language:i,chartAnchor:a,rangeStart:o,rangeEnd:s}=n,c=w(r),l={type:`value`,name:c};if(e.length>0){let t=1/0,n=-1/0;for(let r of e)r<t&&(t=r),r>n&&(n=r);let r=n-t,i=Math.max(r*.1,.5);l.min=Math.floor((t-i)*2)/2,l.max=Math.ceil((n+i)*2)/2}return{xAxis:{type:`time`,min:o,max:Math.abs(s-Date.now())<36e5?a+In:s},yAxis:l,dataZoom:[{type:`inside`,xAxisIndex:0,filterMode:`none`}],tooltip:{trigger:`axis`,axisPointer:{snap:!1},valueFormatter:e=>e.toFixed(1)+`\xA0`+c,formatter:e=>{if(!Array.isArray(e)||e.length===0)return``;let n=`<div style="font-weight:500;margin-bottom:4px">${new Date(e[0].value[0]).toLocaleTimeString([],{hour:`2-digit`,minute:`2-digit`})}</div>`,a=null,o=null;for(let t of e){if(t.seriesId?.endsWith(`_events`))continue;let e=t.value?.[1];e!=null&&(n+=`<div>${t.color?`<span style="display:inline-block;width:8px;height:8px;border-radius:50%;background:${t.color};margin-right:6px"></span>`:``}${t.seriesName}: ${e.toFixed(1)}\u00A0${c}</div>`,t.seriesId===`room_temp`&&(a=e),t.seriesId===`predicted_temp`&&(o=e))}if(a!==null&&o!==null){let e=a-o;n+=`<div style="border-top:1px solid rgba(128,128,128,0.3);margin-top:4px;padding-top:4px">Delta: ${e>=0?`+`:``}${e.toFixed(2)}\u00A0${c}</div>`}if(t.length>0){let a=e[0].value[0]/1e3,o=null,s=1/0;for(let e of t){let t=Math.abs(e.ts-a);t<s&&(s=t,o=e)}if(o){let e=[];if(o.mode===`heating`){let t=o.heating_power;t!=null&&t>0&&t<100?e.push(`${C(`analytics.heating_period`,i)} ${t}%`):e.push(C(`analytics.heating_period`,i)),o.device_setpoint!=null&&e.push(`TRV ${O(o.device_setpoint,r)}\u00A0${c}`)}else o.mode===`cooling`&&(e.push(C(`analytics.cooling_period`,i)),o.device_setpoint!=null&&e.push(`AC ${O(o.device_setpoint,r)}\u00A0${c}`));o.window_open&&e.push(C(`analytics.window_open_period`,i)),e.length>0&&(n+=`<div style="border-top:1px solid rgba(128,128,128,0.3);margin-top:4px;padding-top:4px;color:rgba(255,255,255,0.7)">${e.join(` · `)}</div>`),o.blind_position!=null&&(n+=`<div style="color:rgba(255,255,255,0.7)">${C(`analytics.blind_position`,i)} ${100-o.blind_position}%</div>`)}}let s=document.createElement(`div`);return s.innerHTML=n,s}},grid:{top:15,left:10,right:10,bottom:5,containLabel:!0}}}v(),S(),M();var Z=class extends _{constructor(...e){super(...e),this.data=null,this.rangeStart=0,this.rangeEnd=0,this.chartAnchor=0,this.language=`en`,this.isOutdoor=!1,this._hiddenSeries=new Set([`outdoor_temp`,`device_target`]),this._chartInfoExpanded=!1}render(){let e=this.language,t=this.data?[...this.data.history,...this.data.detail]:[],n=[...t,...this.data?.forecast??[]],r={hass:this.hass,language:e,chartAnchor:this.chartAnchor,rangeStart:this.rangeStart,rangeEnd:this.rangeEnd,forecast:this.data?.forecast,isOutdoor:this.isOutdoor},i=t.length>0?Ln(t,r):[],a=[],o=i.map(e=>{let t=e.id,n=e.lineStyle||{},r=t.endsWith(`_events`);if(this._hiddenSeries.has(t)){let t={...e,lineStyle:{...n,width:0,opacity:0}};return e.areaStyle&&(t.areaStyle={...e.areaStyle,opacity:0}),t}if(!r&&t!==`now_marker`)for(let t of e.data)t&&t[1]!=null&&a.push(t[1]);let i={...e,lineStyle:{...n,opacity:1}};return e.areaStyle&&(i.areaStyle={...e.areaStyle,opacity:1}),i}),s=Rn(a,n,r);return h`
      <ha-card>
        <div class="card-header">
...
`).map(e=>h`<p>
        ...
        </p>`)}_toggleSeries(e){let t=new Set(this._hiddenSeries);t.has(e)?t.delete(e):t.add(e),this._hiddenSeries=t}static{this.styles=[Fn,l`
      :host {
        display: block;
      }
    ...
    `}_toggleStat(e){this._expandedStat=this._expandedStat===e?null:e}static{this.styles=[Fn,l`
      :host {
        display: block;
      }
    ...
    `]}};j([b({attribute:!1})],zn.prototype,`hass`,void 0),j([b({attribute:!1})],zn.prototype,`data`,void 0),j([b({type:String})],zn.prototype,`language`,void 0),j([x()],zn.prototype,`_expandedStat`,void 0),zn=j([y(`rme-analytics-model`)],zn),v(),S(),M();var Q=class extends _{constructor(...e){super(...e),this.rooms={},this.initialRoom=``,this.controlMode=`bangbang`,this._selectedRoom=``,this._rangeStart=new Date(new Date().setHours(0,0,0,0)).getTime(),this._rangeEnd=Date.now(),this._data=null,this._chartAnchor=Date.now(),this._loading=!1,this._activeQuick=`24h`}connectedCallback(){super.connectedCallback(),this._refreshInterval=setInterval(()=>this._silentRefresh(),6e4)}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&=(clearInterval(this._refreshInterval),void 0)}willUpdate(e){e.has(`initialRoom`)&&this.initialRoom&&(this._selectedRoom=this.initialRoom);let t=!1;if(e.has(`rooms`)&&!this._selectedRoom){let e=Object.keys(this.rooms);e.length>0&&(this._selectedRoom=e[0],t=!0,this.dispatchEvent(new CustomEvent(`room-selected`,{detail:{areaId:e[0]},bubbles:!0,composed:!0})))}(t||e.has(`_selectedRoom`)||e.has(`_rangeStart`)||e.has(`_rangeEnd`))&&this._selectedRoom&&this._fetchData()}render(){let e=this.hass.language;return h`
      ...
      ${this._selectedRoom?this._loading?h`<div class="loading">${C(`panel.loading`,e)}</div>`:h`
                ...
                ></rme-analytics-chart>
                ${this.rooms[this._selectedRoom]?.is_outdoor?g:h` <rme-analytics-model
                        .hass=${this.hass}
                        .data=${this._data}
                        .language=${e}
                      ></rme-analytics-model>`}
            ...
            `}
    `}_onRoomSelected(e){let t=e.detail.areaId;t&&t!==this._selectedRoom&&(this._selectedRoom=t,this.dispatchEvent(new CustomEvent(`room-selected`,{detail:{areaId:t},bubbles:!0,composed:!0})))}_onRangeChanged(e){let{activeQuick:t,rangeStart:n,rangeEnd:r,chartAnchor:i}=e.detail;this._activeQuick=t,this._rangeStart=n,this._rangeEnd=r,this._chartAnchor=i}_buildWsParams(){return{type:`roommind_eklabs/analytics/get`,area_id:this._selectedRoom,start_ts:this._rangeStart/1e3,end_ts:this._rangeEnd/1e3}}async _fetchData(){if(this._selectedRoom){this._loading=!0,this._data=null,this._chartAnchor=this._rangeEnd;try{let e=await this.hass.callWS(this._buildWsParams());this._data=e}catch(e){console.debug(`[RoomMind] fetchData:`,e),this._data=null}finally{this._loading=!1}}}async _silentRefresh(){if(!(!this._selectedRoom||this._loading))try{let e=await this.hass.callWS(this._buildWsParams());this._data=e,this._chartAnchor=Date.now()}catch(e){console.debug(`[RoomMind] silentRefresh:`,e)}}static{this.styles=l`
    :host {
      display: block;
    }
  ...
  `}connectedCallback(){super.connectedCallback(),un().then(()=>{this._elementsLoaded=!0}),this._loadRooms(),this._refreshInterval=setInterval(()=>this._loadRooms(),5e3),this.addEventListener(`save-status`,this._onSaveStatus),this._routeApplied||=(this._applyRoute(),!0),this._boundVisibilityHandler||(this._boundVisibilityHandler=()=>{if(!document.hidden){if(!this.isConnected){window.location.reload();return}this._loadRooms(),this.requestUpdate()}},document.addEventListener(`visibilitychange`,this._boundVisibilityHandler))}disconnectedCallback(){super.disconnectedCallback(),this._refreshInterval&&=(clearInterval(this._refreshInterval),void 0),this._saveStatusTimeout&&clearTimeout(this._saveStatusTimeout),this.removeEventListener(`save-status`,this._onSaveStatus),this._boundConnectionReady&&=(this.hass?.connection?.removeEventListener(`ready`,this._boundConnectionReady),void 0)}render(){if(!this._elementsLoaded||!this.hass)return h``;let e=this.hass.language,t=!!this._selectedAreaId,n=t?this.hass?.areas?.[this._selectedAreaId]:null,r={areas:C(`panel.tab.rooms`,e),analytics:C(`tabs.analytics`,e),settings:C(`panel.tab.settings`,e)};return h`
    ...
    `}_renderTab(){switch(this._activeTab){case`areas`:return this._renderAreas();case`analytics`:return h`<rme-analytics
          .hass=${this.hass}
          .rooms=${this._rooms}
          .initialRoom=${this._analyticsRoom}
          .controlMode=${this._controlMode}
          @room-selected=${this._onAnalyticsRoomSelected}
        ></rme-analytics>`;case`settings`:return this._renderSettings();default:return g}}_renderAreas(){if(!this._roomsLoaded)return h`<div class="loading">${C(`panel.loading`,this.hass.language)}</div>`;if(this._selectedAreaId){let e=this.hass?.areas?.[this._selectedAreaId];if(e){let t=this._rooms[this._selectedAreaId]??null;return h`
          <rme-room-detail
            .area=${e}
            .config=${t}
            .hass=${this.hass}
