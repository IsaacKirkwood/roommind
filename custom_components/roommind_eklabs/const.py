...
ROOMMIND_CONTEXT_ID = "roommind_eklabs"
...
OUTDOOR_UNAVAILABLE_NOTIFICATION_ID = "roommind_eklabs_outdoor_unavailable"
...
# Whole-house/shared heat source defaults
DEFAULT_SHARED_HEAT_MIN_REQUESTING_ROOMS = 2
DEFAULT_SHARED_HEAT_AGGREGATE_POWER_THRESHOLD = 1.2
DEFAULT_SHARED_HEAT_START_DELTA = 0.5
DEFAULT_SHARED_HEAT_STOP_DELTA = 0.2
DEFAULT_SHARED_HEAT_LOCAL_TRIM_DELTA = 1.0
